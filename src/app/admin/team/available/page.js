...
function AvailableCrewContent() {
  ...
  // 2. Master Client Shoots Roster Database (Cross-referenced to identify busy crew)
  const allClientAssignments = [
    { crewName: "Rohit" },
    { crewName: "Sanoj" },
    { crewName: "Sanjeet" },
    { crewName: "Ritik Saw Kolkata" },
    { crewName: "Manikant (Monu)" },
    { crewName: "Sumit" },
    { crewName: "Sikandar" },
    { crewName: "Vinod Kumar" },
    { crewName: "Pintu Kumar" }
  ];
    ...
    <div className="min-h-screen bg-[#0B0D0E] text-[#F5F5F5] font-sans antialiased p-6 lg:p-10 space-y-6 selection:bg-emerald-400 selection:text-black">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-[#1F242D]">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <Link className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#B89018] hover:from-[#F3E5AB] hover:to-[#D4AF37] text-black text-xs font-sans font-semibold uppercase tracking-wider shadow-lg shadow-[#D4AF37]/25 transition-all" href="/admin/team">
            Master Directory ↗
          </Link>
        </div>
      </div>
                  ...
                  <td colSpan={7} className="py-12 text-center text-xs font-mono text-[#8A7D5C]">
                    <div className="flex flex-col items-center justify-center space-y-2">
                      ...
                      <p className="text-[#8A7D5C] text-xs font-sans">
                        Zero free personnel available on bench. View active duties in the <Link href="/admin/team/busy" className="text-emerald-400 underline">Assigned Roster</Link>.
                      </p>
                    </div>
                  </td>
                </tr>
