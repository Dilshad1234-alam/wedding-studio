    ...
    <div className="min-h-screen bg-[#212639] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-[#2B324B] border border-white/10 rounded-2xl shadow-2xl p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl sm:text-4xl font-serif text-[#B38F4D] mb-2 tracking-wide">Welcome Back</h1>
          <p className="text-gray-300 text-sm tracking-wider">Sign in to your Weddingpur account</p>
        </div>
        ...
        <p className="text-center text-gray-400 text-sm mt-8">
          ...
          <Link href="/register" className="text-[#B38F4D] hover:text-white transition-colors">
            Register
          </Link>
        </p>
