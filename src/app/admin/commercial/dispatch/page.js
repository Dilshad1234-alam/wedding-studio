              ...
              <div key={client.id} className="bg-[#121518] border border-[#2B2519] hover:border-[#D4AF37]/40 rounded-3xl overflow-hidden shadow-2xl transition-all">
                ...
                >
                  ...
                  <div className="flex items-center gap-5 self-end md:self-auto flex-wrap">
                    ...
                    <button
                      type="button"
                      onClick={(e) => { e.stopPropagation(); setCampaignToDelete(client); }}
          ...
          <div className="bg-[#121518] border border-[#2B2519] rounded-3xl p-7 shadow-2xl max-w-sm w-full relative space-y-5 animate-in fade-in zoom-in duration-200">
            ...
            <div className="text-center space-y-1.5">
              ...
              <p className="text-xs text-[#A89D84] leading-relaxed">
                Are you sure you want to remove <strong className="text-white">{campaignToDelete.brandName}</strong>? This action cannot be undone.
              </p>
            </div>
